...
DexHub tracks every capability as an individually toggleable feature in [`.dexCore/_cfg/features.yaml`](.dexCore/_cfg/features.yaml) — 87 features today, classified by status:

| Status | Count | What it means |
|---|---|---|
| `always_on` | 7 | Core infrastructure (DexMaster, SSOT compile, validate.sh, D1 state model, consent tracking) |
| `enabled` | 61 | Shipped and tested — covered by this README |
