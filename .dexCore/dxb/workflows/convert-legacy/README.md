...
The Convert Legacy workflow is a comprehensive migration tool that converts DEX v4 items (agents, workflows, modules) to v5 compliant format with proper structure and conventions. It bridges the gap between legacy DEX implementations and the modern v5 architecture, ensuring seamless migration while preserving functionality and improving structure.
...
The workflow uses standard DXB configuration:

- **draft_folder**: Where converted items will be placed
...
- **Solution**: Ensure all references use `{project-root}/.dexCore/` format
...
- Check conversion mappings at `/dex/dxb/data/v4-to-v5-mappings.yaml`
- Validate output using `checklist.md`
- Consult DEX v5 documentation for proper conventions
