...
- **draft_folder**: Where the module brief will be saved
...
- **Module Brief Document**: Comprehensive planning document at `{draft_folder}/module-brief-{module_code}-{date}.md`
...
- Study existing module examples in `/dex/` for patterns and inspiration
