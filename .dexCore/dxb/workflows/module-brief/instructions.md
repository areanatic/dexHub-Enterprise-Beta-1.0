...
<critical>You MUST have already loaded and processed: {project_root}/.dexCore/dxb/workflows/module-brief/workflow.yaml</critical>
...
- Other DEX modules it might use
