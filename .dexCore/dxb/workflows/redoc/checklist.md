...
- [ ] All DEX convention documents loaded and understood
...
- [ ] Focuses on DISTINCTIVE features, not DEX boilerplate conventions
...
- [ ] DEX convention knowledge applied (describes only distinctive aspects)

## Quality Standards

- [ ] All documentation uses proper DEX terminology
...
- [ ] No redundant explanation of standard DEX patterns
