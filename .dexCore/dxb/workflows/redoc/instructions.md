...
<critical>You MUST have already loaded and processed: {project_root}/.dexCore/dxb/workflows/redoc/workflow.yaml</critical>
...
<step n="1" goal="Load DEX conventions and initialize">
<action>Load ALL DEX convention documents from {dex_conventions}:
...
2. Synthesize understanding:
   ...
   - Input requirements
   - Output produced
   - Unique characteristics (vs standard DEX workflow patterns)
...
3. Identify module's unique purpose within DEX ecosystem
...
4. Generate/update module README.md:
   ...
   Focus on UNIQUE aspects using DEX convention knowledge:
   - Don't explain standard DEX patterns
   - Highlight what makes THIS module distinctive
   - Use proper DEX terminology
