...
<critical>You MUST have already loaded and processed: {project-root}/.dexCore/dxb/workflows/edit-workflow/workflow.yaml</critical>
...
<action>Load example workflows from {project-root}/.dexCore/dxm/workflows/ for patterns</action>
...
2. Convert all file paths to dex/-relative format
...
1. Verify all paths are dex/-relative
...
- [ ] All paths are dex/-relative (no {project-root})
