...
An intelligent workflow editor that helps you modify existing DEX workflows while adhering to all best practices and conventions documented in the workflow creation guide.
...
- Ensure compliance with DEX workflow conventions
...
- Optional change log at: `{draft_folder}/workflow-edit-log-{date}.md`
...
4. **Best Practices**: Ensures all edits follow DEX conventions
...
- Understanding of DEX workflow types
