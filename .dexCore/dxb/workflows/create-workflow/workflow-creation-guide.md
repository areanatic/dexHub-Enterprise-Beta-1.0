# DEX Workflow Creation Guide

Create structured, repeatable workflows for human-AI collaboration in DEX v6.
...
installed_path: '{project-root}/.dexCore/module/workflows/my-workflow'
template: '{installed_path}/template.md'
instructions: '{installed_path}/instructions.md'
default_output_file: '{draft_folder}/output.md'
```
...
<critical>The workflow execution engine is governed by: {project_root}/.dexCore/core/tasks/workflow.xml</critical>
...
That's it! To execute, tell the DEX agent: `workflow my-workflow`
...
| **Location**   | `/src/core/tasks/` | `/dex/*/workflows/`    |
...
# Paths
installed_path: '{project-root}/.dexCore/module/workflows/name'
...
# Output
default_output_file: '{draft_folder}/document.md'
...
4. **Relative Paths**: Use `dex/` root paths (no `{project-root}`)
...
web_bundle:
  ...
  # Core files (dex/-relative paths)
  instructions: 'dex/module/workflows/workflow/instructions.md'
  validation: 'dex/module/workflows/workflow/checklist.md'
  template: 'dex/module/workflows/workflow/template.md'

  # Data files (no config_source allowed)
  data_file: 'dex/module/workflows/workflow/data.csv'

  # Complete file list - CRITICAL!
  web_bundle_files:
    - 'dex/module/workflows/workflow/instructions.md'
    - 'dex/module/workflows/workflow/checklist.md'
    - 'dex/module/workflows/workflow/template.md'
    - 'dex/module/workflows/workflow/data.csv'
...
1. **Remove Config Dependencies**:
   ...
   - Convert `{project-root}/.dexCore/` to `dex/`
...
3. **Test Completeness**:
   ...
   - Verify all paths are relative to dex/
...
web_bundle:
  ...
  instructions: 'dex/dxm/workflows/analyze-requirements/instructions.md'
  validation: 'dex/dxm/workflows/analyze-requirements/checklist.md'
  template: 'dex/dxm/workflows/analyze-requirements/template.md'

  # Data files
  techniques_data: 'dex/dxm/workflows/analyze-requirements/techniques.csv'
  patterns_data: 'dex/dxm/workflows/analyze-requirements/patterns.json'

  # Sub-workflow reference
  validation_workflow: 'dex/dxm/workflows/validate-requirements/workflow.yaml'

  web_bundle_files:
    # Core workflow files
    - 'dex/dxm/workflows/analyze-requirements/instructions.md'
    - 'dex/dxm/workflows/analyze-requirements/checklist.md'
    - 'dex/dxm/workflows/analyze-requirements/template.md'

    # Data files
    - 'dex/dxm/workflows/analyze-requirements/techniques.csv'
    - 'dex/dxm/workflows/analyze-requirements/patterns.json'

    # Sub-workflow and its files
    - 'dex/dxm/workflows/validate-requirements/workflow.yaml'
    - 'dex/dxm/workflows/validate-requirements/instructions.md'
    - 'dex/dxm/workflows/validate-requirements/checklist.md'

    # Shared templates referenced in instructions
    - 'dex/dxm/templates/requirement-item.md'
    - 'dex/dxm/templates/validation-criteria.md'
```
...
- `/dex/dxm/workflows/` - Production examples
