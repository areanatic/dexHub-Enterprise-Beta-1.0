...
<critical>You MUST have already loaded and processed: {project_root}/.dexCore/dxb/workflows/create-workflow/workflow.yaml</critical>
...
- Workflow: {project-root}/.dexCore/core/workflows/brainstorming/workflow.yaml
...
- What module will it belong to? (e.g., "dxm", "dxb", "dis")
...
- If workflow belongs to module: Save to {module_draft_folder}
- If standalone workflow: Save to {standalone_draft_folder}
...
- Author name (default to user_name or "Dex")
...
- Write to {{draft_folder}}/workflow.yaml
  </step>
...
1. ALWAYS include critical headers:
   - Workflow engine reference: {project_root}/.dexCore/core/tasks/workflow.xml
...
- Write to {{draft_folder}}/instructions.md
  </step>
...
- Write to {{draft_folder}}/template.md
  </step>
...
- Write to {{draft_folder}}/checklist.md
  </step>
...
- Check that paths are dex/-relative
...
- Location of created workflow: {{draft_folder}}
- Command to run it
- Next steps:
  - "Run the DEX Method installer to this project location"
