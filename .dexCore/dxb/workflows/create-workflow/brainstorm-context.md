...
_Context provided to brainstorming workflow when creating a new DEX workflow_

## Session Focus

You are brainstorming ideas for a **DEX workflow** - a guided, multi-step process that helps users accomplish complex tasks with structure, consistency, and quality.

## What is a DEX Workflow?
...
A great DEX workflow should be:
...
_This focused context helps create valuable, structured DEX workflows_
