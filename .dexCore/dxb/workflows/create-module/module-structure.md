# DEX Module Structure Guide

## What is a Module?

A DEX module is a self-contained package of agents, workflows, tasks, and resources that work together to provide specialized functionality. Think of it as an expansion pack for the DEX Method.
...
│
└── dex/{module-code}/            # Runtime instance
