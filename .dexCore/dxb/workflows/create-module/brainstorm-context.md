...
_Context provided to brainstorming workflow when creating a new DEX module_

## Session Focus

You are brainstorming ideas for a **complete DEX module** - a self-contained package that extends the DEX Method with specialized domain expertise and capabilities.

## What is a DEX Module?
...
_This focused context helps create cohesive, valuable DEX modules_
