...
_Context provided to brainstorming workflow when creating a new DEX agent_

## Session Focus

You are brainstorming ideas for a **DEX agent** - an AI persona with specific expertise, personality, and capabilities that helps users accomplish tasks through commands and workflows.
...
- **Lisa the Data Analyst**: Crunches numbers, creates visualizations, finds insights
- **Max the DevOps Captain**: Deploys apps, monitors systems, troubleshoots issues
- **Emma the Researcher**: Dives deep into topics, synthesizes findings, creates reports
...
_This focused context helps create distinctive, useful DEX agents_
