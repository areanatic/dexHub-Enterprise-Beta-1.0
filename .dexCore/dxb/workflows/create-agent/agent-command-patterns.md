# DEX Agent Command Patterns Reference
...
<!-- Standard workflow -->
<item cmd="*create-prd"
     run-workflow="{project-root}/.dexCore/dxm/workflows/prd/workflow.yaml">
  Create Product Requirements Document
</item>

<!-- Workflow with validation -->
<item cmd="*validate-prd"
     validate-workflow="{draft_folder}/prd-draft.md"
     workflow="{project-root}/.dexCore/dxm/workflows/prd/workflow.yaml">
  Validate PRD Against Checklist
</item>

<!-- Auto-discover validation workflow from document -->
<item cmd="*validate-doc"
     validate-workflow="{draft_folder}/document.md">
...
<!-- Simple task -->
<item cmd="*validate"
   exec="{project-root}/.dexCore/core/tasks/validate-workflow.xml">
  Validate document against checklist
</item>

<!-- Task with data -->
<item cmd="*standup"
   exec="{project-root}/.dexCore/mmm/tasks/daily-standup.xml"
   data="{project-root}/.dexCore/_cfg/agent-party.xml">
...
```xml
<item cmd="*brief"
   exec="{project-root}/.dexCore/core/tasks/create-doc.md"
   tmpl="{project-root}/.dexCore/dxm/templates/brief.md">
  Produce Project Brief
</item>

<item cmd="*competitor-analysis"
   exec="{project-root}/.dexCore/core/tasks/create-doc.md"
   tmpl="{project-root}/.dexCore/dxm/templates/competitor.md"
   data="{project-root}/.dexCore/_data/market-research.csv">
...
<item cmd="*list-tasks"
   action="list all tasks from {project-root}/.dexCore/_cfg/task-manifest.csv">
...
<agent name="Research Assistant">
  ...
  <menu>
    ...
    <item cmd="*review-literature"
       ...
       data="{project-root}/.dexCore/_data/sources.csv">
...
<!-- Workflow with data -->
<item cmd="*brainstorm"
   run-workflow="{project-root}/.dexCore/core/workflows/brainstorming/workflow.yaml"
   data="{project-root}/.dexCore/core/workflows/brainstorming/brain-methods.csv">
...
<item cmd="*analyze-metrics"
   ...
   data="{project-root}/.dexCore/_data/performance-metrics.json">
...
<item cmd="*report"
   exec="{project-root}/.dexCore/core/tasks/create-doc.md"
   tmpl="{project-root}/.dexCore/dxm/templates/report.md"
   data="{project-root}/.dexCore/_data/quarterly-results.csv">
...
3. *create-agent - Build new DEX agent
...
<item cmd="*{action}-{object}"
   run-workflow="{project-root}/.dexCore/{module}/workflows/{workflow}/workflow.yaml">
...
<item cmd="*validate-{object}"
   validate-workflow="{draft_folder}/{document}.md"
   workflow="{project-root}/.dexCore/{module}/workflows/{workflow}/workflow.yaml">
...
```xml
<item cmd="*{action}"
   exec="{project-root}/.dexCore/{module}/tasks/{task}.md">
  {Action Description}
</item>
```
...
<item cmd="*{document}"
   exec="{project-root}/.dexCore/core/tasks/create-doc.md"
   tmpl="{project-root}/.dexCore/{module}/templates/{template}.md">
...
```xml
<agent id="dex/research/agents/analyst.md" name="Research Analyst" icon="🔬">
  ...
  <menu>
    ...
    <item cmd="*compete"
       ...
       data="{project-root}/.dexCore/_data/market-data.csv">
      Analyze Competition
    </item>
    ...
    <item cmd="*report"
       exec="{project-root}/.dexCore/core/tasks/create-doc.md"
       tmpl="{project-root}/.dexCore/research/templates/report.md">
...
<agent name="Data Analyst">
  <menu>
    ...
    <item cmd="*analyze"
       ...
       data="{project-root}/.dexCore/_data/dataset.csv">
      Analyze Dataset
    </item>
