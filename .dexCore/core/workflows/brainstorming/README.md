...
The workflow leverages configuration from `/dex/dis/config.yaml`:

- **draft_folder**: Where session results are saved
...
- **Primary output**: Structured session report saved to `{draft_folder}/brainstorming-session-results-{date}.md`
...
- Access to the DIS module configuration (`/dex/dis/config.yaml`)
...
- Follow DEX documentation standards for workflow customization

---

_Part of the Dex Method v5 - Creative Ideation and Synthesis (DIS) Module_
