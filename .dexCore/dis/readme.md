...
# Creative Intelligence System (DIS)

**Purpose:** Transform creative and strategic thinking through AI-powered facilitation across five specialized domains. The DIS module provides expert coaching for brainstorming, design thinking, problem-solving, innovation strategy, and storytelling.

**Overview:** The Creative Intelligence System equips teams and individuals with structured creative methodologies delivered through distinctive agent personas. Each agent facilitates interactive workflows that guide users through proven techniques while adapting to context, energy levels, and goals. Unlike traditional creative tools, DIS agents act as master facilitators who ask questions to draw out insights rather than generating solutions directly.
...
The module uses `/dex/dis/config.yaml` for:

- `draft_folder` - Where workflow results are saved
...
The DIS module installer (`_module-installer/`) configures the complete creative intelligence suite including all agents, workflows, and technique libraries.
...
_Part of the DEX Method v6.0 - Transform your creative potential with expert AI facilitation_
