...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*plan-project" workflow="{project-root}/.dexCore/dxm/workflows/2-plan/workflow.yaml">Analyze Project Scope and Create PRD or Smaller Tech Spec</item>
    <item cmd="*validate" exec="{project-root}/.dexCore/core/tasks/validate-workflow.xml">Validate any document against its workflow checklist</item>
