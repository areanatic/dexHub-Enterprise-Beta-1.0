...
# DXM Workflows - The Complete v6 Flow

The DXM (DEX Method Module) orchestrates software development through four distinct phases, each with specialized workflows that adapt to project scale (Level 0-4) and context (greenfield vs brownfield). This document serves as the master guide for understanding how these workflows interconnect to deliver the revolutionary v6 methodology.
...
```bash
# Phase 1: Analysis (Optional)
dex analyst brainstorm-project
dex analyst research
dex analyst product-brief

# Phase 2: Planning
dex pm plan-project

# Phase 3: Solutioning (L3-4)
dex architect solution-architecture
dex architect tech-spec  # Per epic, JIT

# Phase 4: Implementation
dex sm create-story      # One at a time
dex sm story-context     # After each story
dex dev develop          # With context loaded
dex dev review-story     # Or SR agent
dex sm correct-course    # If issues
dex sm retrospective     # After epic
```
...
This document serves as the authoritative guide to DXM v6a workflow execution. For detailed information about individual workflows, see their respective README files in the workflow folders.
