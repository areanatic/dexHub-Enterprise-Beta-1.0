...
- By path:
  - `workflow {project-root}/.dexCore/dxm/workflows/4-implementation/review-story/workflow.yaml`

## Inputs and Variables

- `story_path` (optional): Explicit path to a story file
- `story_dir` (from config): `{project-root}/.dexCore/dxm/config.yaml` → `dev_story_location`
...
- `arch_docs_search_dirs`: Defaults to `docs/` and `drafts/`
...
_Part of the DEX Method v6 — Implementation Phase_
