...
<critical>You MUST have already loaded and processed: {project-root}/.dexCore/dxm/workflows/4-implementation/correct-course/workflow.yaml</critical>
...
<step n="2" goal="Execute Change Analysis Checklist">
  <action>Load and execute the systematic analysis from: {project-root}/.dexCore/dxm/workflows/4-implementation/correct-course/checklist.md</action>
