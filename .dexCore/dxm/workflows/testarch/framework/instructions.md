...
```xml
<task id="dex/dxm/testarch/framework" name="Test Framework Setup">
  <llm critical="true">
  ...
  <notes>
    <i>Consult `{project-root}/.dexCore/dxm/testarch/tea-index.csv` to identify and load the `knowledge/` fragments relevant to this task (fixtures, network, config).</i>
