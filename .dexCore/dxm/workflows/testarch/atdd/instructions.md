...
```xml
<task id="dex/dxm/testarch/atdd" name="Acceptance Test Driven Development">
  <llm critical="true">
  ...
  <notes>
    <i>Consult `{project-root}/.dexCore/dxm/testarch/tea-index.csv` to identify ATDD-related fragments (fixture-architecture, data-factories, component-tdd) and load them from `knowledge/`.</i>
