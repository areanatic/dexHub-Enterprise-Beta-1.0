...
```xml
<task id="dex/dxm/testarch/gate" name="Quality Gate">
  <llm critical="true">
  ...
  <notes>
    <i>Pull the risk-governance, probability-impact, and test-quality fragments via `{project-root}/.dexCore/dxm/testarch/tea-index.csv` before issuing a gate decision.</i>
