...
```xml
<task id="dex/dxm/testarch/nfr-assess" name="NFR Assessment">
  <llm critical="true">
  ...
  <notes>
    <i>Load the `nfr-criteria`, `ci-burn-in`, and relevant fragments via `{project-root}/.dexCore/dxm/testarch/tea-index.csv` to ground the assessment.</i>
