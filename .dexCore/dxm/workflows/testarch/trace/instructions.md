...
```xml
<task id="dex/dxm/testarch/trace" name="Requirements Traceability">
  <llm critical="true">
  ...
  <notes>
    <i>Use `{project-root}/.dexCore/dxm/testarch/tea-index.csv` to load traceability-relevant fragments (risk-governance, selective-testing, test-quality) as needed.</i>
