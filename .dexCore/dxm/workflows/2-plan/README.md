...
- **draft_folder**: Where all generated documents are stored
...
- **Project Configuration**: Valid config.yaml with project_name and draft_folder
...
- Review the workflow creation guide at `/.dexCore/dxb/workflows/create-workflow/workflow-creation-guide.md`
...
_Part of the Dex Method v6 - DXM (Method) Module_
