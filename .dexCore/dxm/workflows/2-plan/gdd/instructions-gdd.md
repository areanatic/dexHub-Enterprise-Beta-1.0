...
<action if="new or starting fresh">Check or existing game-brief in draft_folder</action>
...
<check if="user selects option 1 or fuzzy indicates wanting to create the narrative design document">
  <invoke-workflow>{project-root}/.dexCore/dxm/workflows/2-plan/narrative/workflow.yaml</invoke-workflow>
