...
└── claude-code/                   # Claude Code enhancements (optional)
    ...
    └── sub-agents/                # Specialized research agents
        ...
        ├── dxm-trend-spotter.md
        ├── dxm-data-analyst.md
        ├── dxm-competitor-analyzer.md
        ├── dxm-user-researcher.md
        └── dxm-technical-evaluator.md
```
...
1. **dxm-market-researcher** - Market intelligence gathering
2. **dxm-trend-spotter** - Emerging trends and weak signals
3. **dxm-data-analyst** - Quantitative analysis and modeling
4. **dxm-competitor-analyzer** - Competitive intelligence
...
- Review workflow creation guide at `/.dexCore/dxb/workflows/create-workflow/workflow-creation-guide.md`
...
_Part of the Dex Method v6 - DXM (Dex Method) Module - Empowering systematic research and analysis_
