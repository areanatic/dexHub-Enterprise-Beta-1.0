...
<critical>This is a meta-workflow that orchestrates the DIS brainstorming workflow with project-specific context</critical>
...
<workflow>
  ...
  <step n="2" goal="Invoke core brainstorming with project context">
    <action>Execute the DIS brainstorming workflow with project context</action>
